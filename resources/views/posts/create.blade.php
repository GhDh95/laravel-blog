<x-layout>
    <section class="max-w-md mx-auto">
        ...
        <form class="space-y-4 md:space-y-6" method="POST" action="/admin/posts" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div>
                <label for="thumbnail" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    Thumbnail</label>
                <input value="{{ old('thumbnail') }}" type="file" name="thumbnail" id="thumbnail"
                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
